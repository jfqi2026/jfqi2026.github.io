...
Contact emails: [jessica.bavaresco@lip6.fr](mailto:Jessica.Bavaresco@lip6.fr) and [marco.quintino@lip6.fr](mailto:Marco.Quintino@lip6.fr)

**Funding:**
<div class="funding-logos">
  <a href="https://jfli.cnrs.fr"><img class="funding-logo-jfli" src="{{ '/assets/img/JFLI-funding.png' | relative_url }}" alt="JFLI"></a>
  <a href="https://qics.sorbonne-universite.fr"><img src="{{ '/assets/img/QICS-logo.png' | relative_url }}" alt="Quantum Information Center Sorbonne (QICS)"></a>
</div>

This workshop is supported by the [Japanese-French Laboratory for Informatics (JFLI)](https://jfli.cnrs.fr).<br>
This workshop is supported by the programme d'investissements d’excellence IDEX of the Alliance Sorbonne Université through the [Quantum Information Center Sorbonne (QICS)](https://qics.sorbonne-universite.fr/en).

**The JFLI is a partnership of:**

![Sorbonne Université, CNRS, NII, Keio University, and the University of Tokyo](/assets/img/Partner_institutions.png){: .img-fluid }
